...
acf_add_local_field_group( [
    ...
    'fields' => [
        ...
        [
            'key' => 'field_5e738485ed5fa',
            'label' => 'Scheduled emails',
            'name' => 'email_posts',
            'type' => 'repeater',
            'instructions' => 'Add as many emails you need. Leave the content empty to post the excerpt of the article. Non-scheduled emails are published at the same time as the article or an update is published.',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => [
                'width' => '',
            ...
            'sub_fields' => [
                [
                    ...
                    'default_value' => '',
                    'placeholder' => '',
                    'maxlength' => Plugin::option( 'email_length', PHP_INT_MAX ),
                    'rows' => 3,
                    'new_lines' => 'wpautop',
                ],
                [
                    'key' => 'field_5e738486ed5fc',
                    'label' => 'Schedule',
                    'name' => 'date_and_time',
                    'type' => 'date_time_picker',
                    'instructions' => '',
