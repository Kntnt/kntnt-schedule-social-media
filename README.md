# Kntnt Schedule Social Media

WordPress plugin that allows authors of posts to schedule social media posts that are published through webhooks. 
...
This plugin is currently [hosted on GitHub](https://github.com/kntnt/kntnt-schedule-social-media); one way would be to ["watch" the repository](https://help.github.com/articles/watching-and-unwatching-repositories/).
...
If you have a questions about the plugin, and cannot find an answer here, start by looking at [issues](https://github.com/kntnt/kntnt-schedule-social-media/issues) and [pull requests](https://github.com/kntnt/kntnt-schedule-social-media/pulls). If you still cannot find the answer, feel free to ask in the the plugin's [issue tracker](https://github.com/kntnt/kntnt-schedule-social-media/issues) at Github.

### How can I report a bug?

If you have found a potential bug, please report it on the plugin's [issue tracker](https://github.com/kntnt/kntnt-schedule-social-media/issues) at Github.

### How can I contribute?

Contributions to the code or documentation are much appreciated.

If you are unfamiliar with Git, please date it as a new issue on the plugin's [issue tracker](https://github.com/kntnt/kntnt-schedule-social-media/issues) at Github.
